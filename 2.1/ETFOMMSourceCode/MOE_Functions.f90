...
! ======================================================================
  ...
  ALLOCATABLE SAVED
  SAVE SAVED
  INTEGER :: STATUS, TEMP, RSAVE, MTIME, MOENUM, MDAT, IBR
  REAL :: R1, R2
  ...
  ELSE
    IF(.NOT. ALLOCATED(SAVED)) THEN
      ALLOCATE(SAVED(5, 500, 8), STAT = STATUS)
      IF(STATUS .NE. 0) GOTO 10
      SAVED = 0.0
    ENDIF
...
! Returns: int = 1 - MOE name was not recognized
! ======================================================================
  INTEGER FUNCTION GETBUSSTATIONMOEDATA &
  ...
  ALLOCATABLE SAVED
  SAVE SAVED
  INTEGER :: STATUS, RSAVE, MTIME, MOENUM, MDAT, ISTAT
  ...
  ELSE
    IF(.NOT. ALLOCATED(SAVED)) THEN
      ALLOCATE(SAVED(4, 99, 8), STAT = STATUS)
      IF(STATUS .NE. 0) GOTO 10
      SAVED = 0.0
    ENDIF
