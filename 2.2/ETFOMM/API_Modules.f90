...
!      INTEGER :: CENTRALNODE; WILL CHANGE LATER LZ 06/16/2024
!    INTEGER :: SIGNALNODE(8)//WILL CHANGE LATER wcf definfition is still node an inmteger , not an array
!        CHECK ETEDITOR
      INTEGER :: NODE(8)
    INTEGER :: CFAILS
    INTEGER :: ADJ
    INTEGER :: ACTUATED_MODE(8)
    INTEGER :: DUAL_ENTRY_CODE(8)
    LOGICAL :: LEFTARROW(8, 10)
    LOGICAL :: THRUARROW(8, 10)
    LOGICAL :: RIGHTARROW(8, 10)
    LOGICAL :: LDIAGARROW(8, 10)
    LOGICAL :: RDIAGARROW(8, 10)
    ...
    INTEGER :: DIRECT_APPROACH_USN(10)
    INTEGER :: DIRECT_APPROACH_DSN(10)
    ...
    INTEGER :: CHECKIN_DISTANCE(8, 10)
    INTEGER :: CHECKOUT_DISTANCE(8, 10)
    INTEGER :: POLICY(8, 10)
    !INTEGER :: RTMODE(8, 10)
  END TYPE
  ...
  TYPE,  BIND(C):: FV_STRUCT
    ...
    INTEGER :: VTYPE
    INTEGER :: XCODE
    INTEGER :: WILL_COOP_EV
    INTEGER :: WILL_COOP_LC
    INTEGER :: WILL_MOVE
    INTEGER :: DESTINATION
    REAL    :: DISTANCE_TO_SEGMENT_END,LGE,lhbt,lp
    INTEGER :: DIVERTED
    INTEGER :: HOV_VIOLATOR
    INTEGER :: IMETER
  ...
  TYPE BUSR
    INTEGER :: NUMBER
    INTEGER :: TYPE_OF_ROUTE
    INTEGER :: NUMBER_OF_TRAMCARS
    INTEGER :: HDWY
    INTEGER :: OFFSET
    INTEGER :: NNODES
  ...
  TYPE EVENT_DATA
   ...
   INTEGER :: CODE
   INTEGER :: GROUP_ID
   INTEGER :: APPROACH_USN
   INTEGER :: APPROACH_DSN
  END TYPE
