...
! --- used in the TSD file.
    ...
    INTEGER, ALLOCATABLE :: sfirst_transit_detector(:)
    ...
    LOGICAL, ALLOCATABLE :: RTOR_BLOCKAGE(:)
    ...
    REAL   , ALLOCATABLE :: COND_LDIAGPCT(:,:)
    REAL   , ALLOCATABLE :: COND_RDIAGPCT(:,:)
    LOGICAL, ALLOCATABLE :: COND_LEFT(:)
    REAL   , ALLOCATABLE :: COND_LEFTPCT(:,:)
    LOGICAL, ALLOCATABLE :: COND_THRU(:)
    REAL   , ALLOCATABLE :: COND_THRUPCT(:,:)
    LOGICAL, ALLOCATABLE :: COND_RIGHT(:)
    REAL   , ALLOCATABLE :: COND_RIGHTPCT(:,:)
    ...
    INTEGER, ALLOCATABLE :: CROSS_WALK(:) 
    LOGICAL, ALLOCATABLE :: TRAM_LINK(:) 
    integer, allocatable :: priority_link_phase(:) 
...
! ==================================================================================================
    ...
    IF(N_STREET_LINKS .GT. 0) THEN
      ...
      SFIRST_DETECTOR = 0
      ALLOCATE(sfirst_transit_detector(N_STREET_LINKS))
      sfirst_transit_detector = 0
      ...
      BLOCKAGE = 0
      ALLOCATE(RTOR_BLOCKAGE(N_STREET_LINKS))
      RTOR_BLOCKAGE = .FALSE.
      ...
      RT_SPEED = 13
      ALLOCATE(CROSS_WALK(N_STREET_LINKS))
      CROSS_WALK = 0
      ALLOCATE(TRAM_LINK(N_STREET_LINKS))
      TRAM_LINK = .FALSE.
      ALLOCATE(priority_link_phase(N_STREET_LINKS))
      priority_link_phase = 0
...
! ----------------------------------------------------------------------
    ...
    CALL REALLOCATE_INTEGER(sfirst_transit_detector, I1, I2)
    ...
    CALL REALLOCATE_LOGICAL(RTOR_BLOCKAGE, I1, I2)
    ...
    CALL REALLOCATE_REAL_X(COND_LEFTPCT, I1, I2, 5)
    CALL REALLOCATE_REAL_X(COND_THRUPCT, I1, I2, 5)
    CALL REALLOCATE_REAL_X(COND_RIGHTPCT, I1, I2, 5)
    CALL REALLOCATE_REAL_X(COND_LDIAGPCT, I1, I2, 5)
    CALL REALLOCATE_REAL_X(COND_RDIAGPCT, I1, I2, 5)
    ...
    CALL REALLOCATE_INTEGER(CROSS_WALK, I1, I2)
    CALL REALLOCATE_LOGICAL(TRAM_LINK, I1, I2)
    CALL REALLOCATE_integer(priority_link_phase, I1, I2)
    RETURN
    END SUBROUTINE
  ...
  ! ==================================================================================================
    ...
    IF(ALLOCATED(SUSN)) THEN
      ...
      DEALLOCATE(sfirst_transit_detector)
      DEALLOCATE(SGRADE)
      ...
      DEALLOCATE(LT_SPEED)
      DEALLOCATE(RT_SPEED)
      DEALLOCATE(CROSS_WALK)
      DEALLOCATE(TRAM_LINK)
      DEALLOCATE(priority_link_phase)
    ENDIF
    RETURN
    END SUBROUTINE
...
! --- Save static data.
    ...
    IF(FIRST) THEN
      ...
      WRITE(FILE1) sfirst_transit_detector
      WRITE(FILE1) SGRADE
      ...
      WRITE(FILE1) CROSS_WALK
      WRITE(FILE1) TRAM_LINK
      WRITE(FILE1) priority_link_phase
    ENDIF
...
! --- Restore static data.
    ...
    READ(FILE1) sfirst_transit_detector
    READ(FILE1) SGRADE
    ...
    READ(FILE1) LT_SPEED
    READ(FILE1) RT_SPEED
    READ(FILE1) CROSS_WALK
    READ(FILE1) TRAM_LINK
    READ(FILE1) priority_link_phase
