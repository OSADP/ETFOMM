...
! ----------------------------------------------------------------------
  ...
  DO I = 1, N_STREET_LINKS
    ...
    STRING = ''
    WRITE(STRING, 4, ERR=20, IOMSG=ETEXT) SUSN(I), SDSN(I), SNUMLANES(I), &
...
1 FORMAT(I6,',',I8,',',I8,',',I2,',',I2,',',F12.7,',',F12.7,',',I8)  
2 FORMAT(I4, A)
3 FORMAT(2(I6,','),2(I4,','),2(I6,','),31(I4,','),I4)  
4 FORMAT(2(I6,','),5(I2,','),5(I6,','),I4)
  RETURN
...
! ----------------------------------------------------------------------
  ...
  ENDIF
  W = 1
  IF(THELINKDATA%USN .GT. 9999) THEN
    W(2) = 5
  ELSEIF(THELINKDATA%USN .GT. 999) THEN
    W(2) = 4
  ...
  ELSEIF(THELINKDATA%USN .GT. 9) THEN
    W(2) = 2
  ENDIF
  IF(THELINKDATA%DSN .GT. 9999) THEN
    W(3) = 5
  ELSEIF(THELINKDATA%DSN .GT. 999) THEN
    W(3) = 4
...
!#undefine ET_Animator
#ifdef ET_Animator
  IF(THELINKDATA%LTURNMOVECODE .EQ. S_YIELD) THEN
    THELINKDATA%LTURNMOVECODE = 0
  ELSEIF(THELINKDATA%LTURNMOVECODE .EQ. S_GREEN) THEN
    THELINKDATA%LTURNMOVECODE = 1
  ELSEIF(THELINKDATA%LTURNMOVECODE .EQ. S_PERGRN) THEN
    THELINKDATA%LTURNMOVECODE = 1
  ELSEIF(THELINKDATA%LTURNMOVECODE .EQ. S_STOP) THEN
    THELINKDATA%LTURNMOVECODE = 5
  ENDIF
  IF(THELINKDATA%THRUMOVECODE .EQ. S_YIELD) THEN
    THELINKDATA%THRUMOVECODE = 0
  ELSEIF(THELINKDATA%THRUMOVECODE .EQ. S_GREEN) THEN
    THELINKDATA%THRUMOVECODE = 1
  ELSEIF(THELINKDATA%THRUMOVECODE .EQ. S_PERGRN) THEN
    THELINKDATA%THRUMOVECODE = 1
  ELSEIF(THELINKDATA%THRUMOVECODE .EQ. S_STOP) THEN
    THELINKDATA%THRUMOVECODE = 5
  ENDIF
  IF(THELINKDATA%RTURNMOVECODE .EQ. S_YIELD) THEN
    THELINKDATA%RTURNMOVECODE = 0
  ELSEIF(THELINKDATA%RTURNMOVECODE .EQ. S_GREEN) THEN
    THELINKDATA%RTURNMOVECODE = 1
  ELSEIF(THELINKDATA%RTURNMOVECODE .EQ. S_PERGRN) THEN
    THELINKDATA%RTURNMOVECODE = 1
  ELSEIF(THELINKDATA%RTURNMOVECODE .EQ. S_STOP) THEN
    THELINKDATA%RTURNMOVECODE = 5
  ENDIF
  IF(THELINKDATA%LDIAGMOVECODE .EQ. S_YIELD) THEN
    THELINKDATA%LDIAGMOVECODE = 0
  ELSEIF(THELINKDATA%LDIAGMOVECODE .EQ. S_GREEN) THEN
    THELINKDATA%LDIAGMOVECODE = 1
  ELSEIF(THELINKDATA%LDIAGMOVECODE .EQ. S_PERGRN) THEN
    THELINKDATA%LDIAGMOVECODE = 1
  ELSEIF(THELINKDATA%LDIAGMOVECODE .EQ. S_STOP) THEN
    THELINKDATA%LDIAGMOVECODE = 5
  ENDIF
  IF(THELINKDATA%RDIAGMOVECODE .EQ. S_YIELD) THEN
    THELINKDATA%RDIAGMOVECODE = 0
  ELSEIF(THELINKDATA%RDIAGMOVECODE .EQ. S_GREEN) THEN
    THELINKDATA%RDIAGMOVECODE = 1
  ELSEIF(THELINKDATA%RDIAGMOVECODE .EQ. S_PERGRN) THEN
    THELINKDATA%RDIAGMOVECODE = 1
  ELSEIF(THELINKDATA%RDIAGMOVECODE .EQ. S_STOP) THEN
    THELINKDATA%RDIAGMOVECODE = 5
  ENDIF
#endif  
  WRITE(N, 1, ERR=20, IOMSG=ETEXT) SIMTIME, THELINKDATA
1 FORMAT(F<T+D+1>.<D>,',',I<W(1)>,',',I<W(2)>,',',I<W(3)>,',',I<W(4)>,',',I,',',I,',',I,',',I,',',I,',', &
...
! ----------------------------------------------------------------------
  ...
  ELSEIF(THIS_VEHICLE%GLOBALID .GT. 9) THEN
    W(1) = 2
  ENDIF
  IF(NODE .GT. 9999) THEN
    W(2) = 5
  ELSEIF(NODE .GT. 999) THEN
    W(2) = 4
...
1 FORMAT(I<W(1)>,',',I<W(2)>,',',I<W(3)>,',',I<W(4)>,',',I<W(5)>,',',I<W(6)>)
  RETURN
10 WRITE(MSGTEXT, '(A)') 'WRITE_VEHICLE_LIST : FILE OPEN ERROR'
  CALL SENDTEXTMSG(M_ERROR)
  WRITE(MSGTEXT, '(A)') ETEXT
  CALL SENDTEXTMSG(M_ERROR)
  RETURN
20 WRITE(MSGTEXT, '(A)') 'WRITE_VEHICLE_LIST : FILE WRITE ERROR'
  CALL SENDTEXTMSG(M_ERROR)
  WRITE(MSGTEXT, '(A)') ETEXT
  CALL SENDTEXTMSG(M_ERROR)
  RETURN
  ...
  SUBROUTINE WRITE_VEHICLE_TEXT(USN, DSN, THEVEHDATA, PATHID)
  USE ANIMATION_DATA
  USE SIMPARAMS
  USE TEXT
  IMPLICIT NONE
  TYPE(VEHICLEDATA) :: THEVEHDATA
  INTEGER*2, INTENT(IN) :: USN, DSN, PATHID
  INTEGER :: N = 5, W(15), T, D, US, DS
  LOGICAL :: FIRST = .TRUE.
  INCLUDE 'IOFILES.INC'
! ----------------------------------------------------------------------
  IF(FIRST) THEN
  ...
  IF(THEVEHDATA%LANENUMBER .GT. 9) THEN
    W(2) = 2
  ENDIF
  IF(THEVEHDATA%DISTANCEFROMUSN .GT. 999999) THEN
    W(3) = 7
  ELSEIF(THEVEHDATA%DISTANCEFROMUSN .GT. 99999) THEN
    W(3) = 6
  ...
  ELSE
    W(3) = 2
  ENDIF
  IF(THEVEHDATA%USNPREVLINK .GT. 9999) THEN
    W(4) = 5
  ELSEIF(THEVEHDATA%USNPREVLINK .GT. 999) THEN
    W(4) = 4
  ...
  IF(THEVEHDATA%TARGETLANE .GT. 9) THEN
    W(10) = 2
  ENDIF
  IF(THEVEHDATA%DESTINATION .GT. 9999) THEN
    W(11) = 5
  ELSEIF(THEVEHDATA%DESTINATION .GT. 999) THEN
    W(11) = 4
  ...
  IF(THEVEHDATA%PREVLANE .GT. 9) THEN
    W(14) = 2
  ENDIF
  IF(PATHID .GT. 99) THEN
    W(15) = 3
  ELSEIF(PATHID .GT. 9) THEN
    W(15) = 2
  ENDIF
  ...
  THEVEHDATA%TARGETLANE, THEVEHDATA%DESTINATION, THEVEHDATA%LEADVEHICLEID, THEVEHDATA%FOLLOWVEHICLEID, THEVEHDATA%PREVLANE, PATHID
1 FORMAT(F<T+D+1>.<D>,',',I<US>',',I<DS>',',I<W(1)>,',',I<W(2)>,',' ,I<W(3)>,',',I<W(4)>,',', I<W(5)>,',',I<W(6)>,',',I<W(7)>,',', &
  I<W(8)>,',',I<W(9)>,',',I<W(10)>,',',I<W(11)>,',',I<W(12)>,',',I<W(13)>',',I<W(14)>',',I<W(15)>)
  RETURN
...
1 FORMAT(F<T+D+1>.<D>,','I<W(1)>,',',F<3+W(2)>.2, ',', I<W(3)>,','I1,','I<W(4)>,','I<W(5)>)
  RETURN
...
1 FORMAT(F<T+D+1>.<D>,',',I8,',',I8,',',I2,',',F15.1,',',F15.1,',',I8,',',I8,',',F10.1,',',F10.1,',',I4,',',I4,',',I4,',',20(I4,','),19(I4','),I4)
  RETURN
