...
! ----------------------------------------------------------------------
  ...
  IF((LEFT_LINK(IL) .GT. 0 .AND. LEFT_LINK(IL) .LT. 7000) .OR.          &
     (STHRU_LINK(IL) .GT. 0 .AND. STHRU_LINK(IL) .LT. 7000) .OR.        &
     (RIGHT_LINK(IL) .GT. 0 .AND. RIGHT_LINK(IL) .LT. 7000) .OR.        &
     (LEFT_DIAG_LINK(IL) .GT. 0 .AND. LEFT_DIAG_LINK(IL) .LT. 7000) .OR.&
     (RIGHT_DIAG_LINK(IL) .GT. 0 .AND. RIGHT_DIAG_LINK(IL) .LT. 7000)) THEN
    WCHECKEXITNODE = .TRUE.
  ENDIF
  CONTINUE
  RETURN
