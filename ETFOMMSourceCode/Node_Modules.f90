...
! ==================================================================================================
    ...
    ALLOCATE(MAINLINE_APPROACH(MAX_NODE_NUMBER+1000))
    ALLOCATE(RAMP_APPROACH(MAX_NODE_NUMBER+1000))
    ALLOCATE(MERGE_APPROACH(MAX_NODE_NUMBER+1000))
    ALLOCATE(WARN_DISTANCE(MAX_NODE_NUMBER+1000))
    ALLOCATE(HOV_WARN_DISTANCE(MAX_NODE_NUMBER+1000))
    ALLOCATE(DUMMY_ENTRY(MAX_NODE_NUMBER+1000))
    ALLOCATE(DUMMY_EXIT(MAX_NODE_NUMBER+1000))
    ALLOCATE(NODE_OBJECT(MAX_NODE_NUMBER+1000))
    MAINLINE_APPROACH = 0
    RAMP_APPROACH = 0
    MERGE_APPROACH = 0
    WARN_DISTANCE = 0
