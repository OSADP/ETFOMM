...
! along with this program.  If not, see <http://www.gnu.org/licenses/>.
  ...
  MODULE ACTUATED_CONTROLLERS
    ...
    TYPE ACTUATED_DATA
      ...
      REAL    :: GUI_NEW_PED_WALK_TIMES(NPHASES)
      REAL    :: GUI_NEW_PED_CLEARANCE_TIMES(NPHASES)
      LOGICAL :: GUI_NEW_PED_OMIT(NPHASES)
      REAL    :: GUI_NEW_PED_DETECTOR_ASSIGNMENTS(NPHASES)
      REAL    :: GUI_EXTENSION_TIME_INCREMENT
      LOGICAL :: GUI_PED_PHASE(NPHASES)
      INTEGER :: GUI_PED_INTENSITY(NPHASES)
      INTEGER :: GUI_PED_HEADWAY(NPHASES)
      INTEGER :: GUI_ARRIVAL_TIME(NPHASES)
      INTEGER :: GUI_PED_RECALL_CODE(NPHASES)
      INTEGER :: GUI_PED_REST_CODE(NPHASES)
      INTEGER :: GUI_CONST_DEMAND_PERIOD_BEGIN(5)
      INTEGER :: GUI_CONST_DEMAND_PERIOD_END(5)
