...
! --- Vehicle arrays
    ...
    INTEGER              :: FCROSS1(7000:7999, N_INTERFACE_LANES)
    INTEGER              :: FCROSS2(7000:7999, N_INTERFACE_LANES)
...
! --- Vehicle arrays
    ...
    INTEGER              :: SCROSS1(7000:7999, N_INTERFACE_LANES)
    INTEGER              :: SCROSS2(7000:7999, N_INTERFACE_LANES)
    ...
    INTEGER, ALLOCATABLE :: ROUNDABOUT_NUMBER(:)
...
! ----------------------------------------------------------------------
    ...
    ALLOCATE(ROUNDABOUT_NUMBER(MAX_VEHICLES_S))
    ROUNDABOUT_NUMBER = 0
...
! ----------------------------------------------------------------------
    ...
    CALL REALLOCATE_INTEGER(ROUNDABOUT_NUMBER, I1, I2) 
...
! ==================================================================================================
    ...
    IF(ALLOCATED(ROUNDABOUT_NUMBER)) DEALLOCATE(ROUNDABOUT_NUMBER)
